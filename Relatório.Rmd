...
\begin{tabular}{lrrrrrrrrr}
 ...
 & Média & Var. & DP & CV(\%) & Min. & Med. & Max. & CA & Cur. \\ 
  \hline
Comprimento (F)& 136.00 & 451.39 & 21.25 & 15.62 & 98.00 & 136.50 & 177.00 & -0.23 & 2.26 \\ 
  Largura (F)& 102.58 & 171.73 & 13.10 & 12.77 & 81.00 & 102.00 & 132.00 & 0.31 & 2.55 \\ 
  Altura (F) & 51.96 & 66.65 & 8.16 & 15.71 & 38.00 & 51.00 & 67.00 & -0.03 & 2.19 \\ 
  \hline
  Comprimento (M)& 113.38 & 138.77 & 11.78 & 10.39 & 93.00 & 115.00 & 135.00 & -0.08 & 2.10 \\ 
  Largura (M) & 88.29 & 50.04 & 7.07 & 8.01 & 74.00 & 89.00 & 106.00 & 0.20 & 3.15 \\ 
  Altura (M) & 40.71 & 11.26 & 3.36 & 8.24 & 35.00 & 40.00 & 47.00 & 0.18 & 2.20 \\ 
   \hline
\end{tabular}
\end{table}
...
A Figura \ref{disp2} contém a matriz de gráfico de dispersões dos resultados de cada prova. Podemos notar correlações positivas e correlações negativas entre as variáveis. A Tabela \ref{cov2} contem a matriz de covariância dos resultados de cada prova. Podemos notar que as provas de corrida são negativamente correlacionadas com as provas de desempenho medidas em metros. A mesma coisa acontece comparando a covariância entre as provas de desempenho medidas em metros com as provas de corrida.
...
\begin{tabular}{r|rrrrr|r}
  \hline
  & \multicolumn{5}{c}{Status Socioeconômico} & \\
  \hline
...
\begin{tabular}{l|l|rr}
  \hline
   &\bf{Categoria} & \bf{Componente 1} & \bf{Componente 2} \\ 
  \hline
  Perfil das Linhas & Boa & 0.1923 & 0.0773 \\ 
  & Presença fraca de sintomas & 0.0202 & -0.0676 \\ 
  & Presença moderada de sintomas & -0.0467 & -0.0797 \\ 
  & Debilitado & -0.1111 & 0.0937 \\
  \hline
  Perfil das Colunas & A & 0.0191 & 0.1064 \\ 
  & B & 0.1153 & -0.0984 \\ 
  & C & 0.0678 & -0.0423 \\ 
  & D & -0.0848 & -0.0365 \\ 
  & E & -0.2222 & -0.0479 \\ 
...
A Tabela \ref{med_pos} contém as medidas resumo das portadoras da herança genética "prima". Podemos notar que, com exceção de "Gravidez" e "Tríceps" para o caso de diabetes positiva, a maioria das variáveis não tem uma curtose ideal (próxima de 3) e o coeficiente de assimetria da maioria das variáveis também não foram ideais.

A Figura \ref{disp_pos} e \ref{disp_neg} contém, respectivamente, a matriz de gráfico de dispersões das pacientes com diabetes e sem diabetes. Podemos no-
tar correlações positivas e correlações negativas entre as variáveis. A Tabela 8 contem a matriz
de covariância dos resultados de cada prova. Podemos notar que as provas de corrida são ne-
gativamente correlacionadas com as provas de desempenho medidas em metros. A mesma coisa
acontece comparando a covariância entre as provas de desempenho medidas em metros com as
provas de corrida.
...
Gravidez & 1.00 & 0.14 & 0.17 & 0.10 & 0.01 & -0.04 & 0.70 \\ 
  ...
  Insulina & 0.01 & 0.62 & 0.12 & 0.15 & 1.00 & 0.27 & 0.05 \\ 
...
qqPlot(scale(indiP[,5]),dist="norm",mean=0,sd=1,col.lines=1,grid="FALSE",xlab="quantil da N(0,1)",ylab="Insulinaa (P)",cex=1.2)
...
qqPlot(scale(indiP[,5]),dist="norm",mean=0,sd=1,col.lines=1,grid="FALSE",xlab="quantil da N(0,1)",ylab="Insulinaa (N)",cex=1.2)
