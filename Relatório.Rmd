...
A análise discriminante para duas populações foi a metodologia escolhida para a classificação entre diabetes positiva e diabetes negativa. A probabilidade à priori foi definida como a proporção de observações de cada categoria do banco de dados (cerca de 66% sem diabetes e 34% com diabetes). Mais informações sobre a metodologia podem ser encontradas em Azevedo (2020).
