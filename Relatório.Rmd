...
\caption{Medidas resumo sexo feminino}
\label{turtleF}
  \hline
 & Média & Var. & DP & CV(\%) & Min. & Med. & Max. & CA & Cur. \\ 
  \hline
length & 136.00 & 451.39 & 21.25 & 15.62 & 98.00 & 136.50 & 177.00 & -0.23 & 2.26 \\ 
  width & 102.58 & 171.73 & 13.10 & 12.77 & 81.00 & 102.00 & 132.00 & 0.31 & 2.55 \\ 
  height & 51.96 & 66.65 & 8.16 & 15.71 & 38.00 & 51.00 & 67.00 & -0.03 & 2.19 \\ 
   \hline
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{rrrrrrrrrr}
\caption{Medidas resumo sexo masculino}
\label{turtleM}
  \hline
 & Média & Var. & DP & CV(\%) & Min. & Med. & Max. & CA & Cur. \\ 
  \hline
length & 113.38 & 138.77 & 11.78 & 10.39 & 93.00 & 115.00 & 135.00 & -0.08 & 2.10 \\ 
  width & 88.29 & 50.04 & 7.07 & 8.01 & 74.00 & 89.00 & 106.00 & 0.20 & 3.15 \\ 
  height & 40.71 & 11.26 & 3.36 & 8.24 & 35.00 & 40.00 & 47.00 & 0.18 & 2.20 \\ 
   \hline
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{rrrr}
\caption{Matriz de covariâncias sexo feminino}
\label{covF}
  \hline
 & length & width & height \\ 
  \hline
  length & 451.39 & 271.17 & 168.70 \\ 
  width & 271.17 & 171.73 & 103.29 \\ 
  height & 168.70 & 103.29 & 66.65 \\ 
   \hline
\end{tabular}
\end{table}
...
\centering
\begin{tabular}{rrrr}
\caption{Matriz de covariâncias sexo masculino}
\label{covM}
  \hline
 & length & width & height \\ 
  \hline
...
\label{Boxhom}
 ...
 & length & width & height \\ 
  \hline
length & 295.08 & 175.16 & 103.04 \\ 
  width & 175.16 & 110.89 & 62.47 \\ 
  height & 103.04 & 62.47 & 38.95 \\ 
   \hline
\end{tabular}
\end{table}
