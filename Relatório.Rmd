...
Nathan Brusamarello de Souto RA 222854} \\[5cm] 
\end{flushright}
...
O objetivo principal da análise é classificar os atletas, com relação as variáveis medidas, bem como reduzir a dimensão dos dados, para futuras análises. A metodologia utilizada para a devida classificação foi a Análise de Componentes Principais, veja mais em [1].
...
legend(2,0.6,lwd=c(2,2),col=c(1,2),legend=c("Positivo","Negativo"),bty="n",cex=0.6)
